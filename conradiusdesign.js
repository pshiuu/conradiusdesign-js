...
// Animate Card 1 (Slide in from the left)
gsap.fromTo(
  '.bento-block.font',
  { opacity: 0, x: '-100%' },
  {
...
// Animate Card 2 (Slide in from the right)
gsap.fromTo(
  '.card-2',
  { opacity: 0, x: '100%' },
  {
...
// Animate Card 3 (Slide in from the top)
gsap.fromTo(
  '.card-3',
  { opacity: 0, y: '-100%' },
  {
...
// Animate Card 4 (Slide in from the bottom)
gsap.fromTo(
  '.card-4',
  { opacity: 0, y: '100%' },
  {
...
// Animate Card 5 (Fade in with scale)
gsap.fromTo(
  '.card-5',
  { opacity: 0, scale: 0.8 },
  {
